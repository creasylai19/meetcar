	...
	public void initData(Bundle savedInstanceState) {
		...
		mUserWidget.btn_getstring.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				mUserWidget.tv_string_show.setText(SystemUtil.getDeviceInfo(CommonUsingAddressActivity.this));
				...
				showProgress();
				VolleySingleInstance.getInstance(CommonUsingAddressActivity.this).addToRequestQueue(getString);
			}
		});
